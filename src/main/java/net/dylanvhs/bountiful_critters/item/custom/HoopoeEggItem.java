...
import net.dylanvhs.bountiful_critters.entity.custom.projectile.HoopoeEggEntity;
...
public class HoopoeEggItem extends Item {
    public HoopoeEggItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            HoopoeEggEntity emu_egg = new HoopoeEggEntity(pLevel, pPlayer);
