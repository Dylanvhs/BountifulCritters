...
public class GeckoRenderer extends GeoEntityRenderer<GeckoEntity> {
    private static final ResourceLocation TEXTURE_LEOPARD = new ResourceLocation(BountifulCritters.MOD_ID, "textures/entity/leopard_gecko.png");
    private static final ResourceLocation TEXTURE_GREEN= new ResourceLocation(BountifulCritters.MOD_ID, "textures/entity/green_gecko.png");
