...
public class ToucanEggEntity extends ThrowableItemProjectile {
    ...
    public ToucanEggEntity(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public ToucanEggEntity(Level pLevel, LivingEntity pShooter) {
        super(ModEntities.TOUCAN_EGG.get(), pShooter, pLevel);
    }

    public ToucanEggEntity(Level pLevel, double pX, double pY, double pZ) {
        super(ModEntities.TOUCAN_EGG.get(), pX, pY, pZ, pLevel);
    }
