...
public final class ModEvents {
    ...
    public static void registerSpawnPlacements(SpawnPlacementRegisterEvent e) {
        e.register(ModEntities.STINGRAY.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.WORLD_SURFACE, RayEntity::canSpawn, SpawnPlacementRegisterEvent.Operation.OR);
